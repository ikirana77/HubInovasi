...
$pageTitle = 'Nazlah Nazifa | '.tr('Multi-Project Innovator','Multi-Project Innovator');
...
<main id="main-content" class="pm-shell"><div class="container">
 <nav class="pm-breadcrumbs">
  ...
  <span>›</span>
  <strong>Nazlah Nazifa</strong>
 </nav>

 <section class="profile-top">
  <div class="profile-portrait">
   <img src="assets/images/home/innovator-nazlah-nazifa.webp" alt="Potret Nur Nazlah Nazifa binti Mohd Ridzuan, innovator pelajar projek e-Competency KVKS, Durian Radar dan HERS">
  </div>
 ...
 <section class="profile-content">
  <article class="project-showcase pm-card">
   ...
   <p><?= e(tr('Nur Nazlah Nazifa binti Mohd Ridzuan ialah innovator pelajar yang terlibat dalam pembangunan e-Competency KVKS, Durian Radar dan HERS. Penglibatan beliau merentas beberapa projek menunjukkan keupayaan untuk memahami keperluan pengguna, struktur data dan fungsi sistem dalam konteks yang berbeza.','Nur Nazlah Nazifa binti Mohd Ridzuan is a student innovator involved in e-Competency KVKS, Durian Radar and HERS. Her involvement across multiple projects shows her ability to understand user needs, data structures and system functions in different contexts.')) ?></p>
 ...
 <section class="pm-ribbon pm-card">
  <div>
   ...
   <p><?= e(tr('Nazlah menunjukkan bagaimana pelajar boleh berkembang melalui projek sistem, data dan aplikasi sebenar.','Nazlah shows how students can grow through real system, data and application projects.')) ?></p>
  </div>
