<fieldset class="form-section submission-step" data-submission-step="7" hidden>
    ...
    <div class="cp10b-notice" role="note"><strong><?= e(tr('Akan dilengkapkan pada CP10B', 'To be completed in CP10B')) ?></strong><p><?= e(tr('Galeri, pautan dan milestone berulang belum diaktifkan untuk simpanan.', 'Gallery items, links and repeatable milestones are not yet enabled for persistence.')) ?></p></div>
