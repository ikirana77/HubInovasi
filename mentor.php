...
$mentors = [
    ...
    [
        'slug' => 'mentor-web',
        'name' => tr('Mentor Pembangunan Web','Web Development Mentor'),
        'role' => tr('Pembimbing Projek Web','Web Project Coach'),
        'institution' => 'KVKS',
        'image' => 'assets/images/home/innovator-jason.webp',
        'tagline' => tr('Membantu pelajar membina sistem web yang jelas, tersusun dan boleh dipersembahkan.','Helps students build clear, structured and presentable web systems.'),
        'fields' => ['PHP','MySQL','UI/UX','CMS'],
        'projects' => ['CMS Quest','CAReS'],
        'stats' => ['12+', tr('Projek Web','Web Projects')],
        'featured' => false,
    ],
    [
        'slug' => 'mentor-mobile',
        'name' => tr('Mentor Aplikasi Mudah Alih','Mobile App Mentor'),
        'role' => tr('Pembimbing Mobile App','Mobile App Coach'),
        'institution' => 'KVKS',
        'image' => 'assets/images/home/innovator-vania.webp',
        'tagline' => tr('Membimbing prototaip aplikasi mudah alih daripada idea kepada pengalaman pengguna.','Guides mobile app prototypes from idea to user experience.'),
        'fields' => ['Flutter','Firebase','Prototype','UX'],
        'projects' => ['HERS','SPARK'],
        'stats' => ['10+', tr('Prototaip','Prototypes')],
        'featured' => false,
    ],
    [
        'slug' => 'mentor-ai',
        'name' => tr('Mentor AI & Data','AI & Data Mentor'),
        'role' => tr('Pembimbing AI dan Analitik','AI and Analytics Coach'),
        'institution' => 'KVKS',
        'image' => 'assets/images/home/innovator-syazwanie.webp',
        'tagline' => tr('Membantu pelajar membina projek berasaskan data, analitik dan kecerdasan buatan.','Helps students build data, analytics and AI-based projects.'),
        'fields' => ['AI','Computer Vision','Analytics','Data'],
        'projects' => ['Durian Radar'],
        'stats' => ['8+', tr('Projek Data','Data Projects')],
        'featured' => false,
    ],
];
