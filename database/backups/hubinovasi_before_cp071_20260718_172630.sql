...
CREATE TABLE `submissions` (
  ...
  KEY `idx_submissions_owner_status` (`owner_user_id`,`status`,`updated_at`),
  CONSTRAINT `fk_submission_project` FOREIGN KEY (`linked_project_id`) REFERENCES `projects` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_submissions_owner` FOREIGN KEY (`owner_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `user_account_history` (
  ...
  `from_status` enum('pending','active','suspended') COLLATE utf8mb4_unicode_ci NOT NULL,
  `to_status` enum('pending','active','suspended') COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_user_id` bigint unsigned DEFAULT NULL,
  `admin_notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_user_history_admin` (`admin_user_id`),
...
CREATE TABLE `user_login_attempts` (
  ...
  `attempted_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_user_login_attempt_window` (`normalized_email_hash`,`ip_hash`,`success`,`attempted_at`),
  KEY `idx_user_login_attempt_cleanup` (`attempted_at`)
...
INSERT INTO `user_login_attempts` VALUES (6,'e01629ea50e4c3167d99622cac156aad984bcb046b4e995404cf111066160072','eff8e7ca506627fe15dda5e0e512fcaad70b6d520f37cc76597fdb4f2d83a1a3',1,'2026-07-18 08:54:47');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`),
  KEY `fk_users_approver` (`approved_by_admin_id`),
  KEY `idx_users_status_role` (`account_status`,`role`),
  KEY `idx_users_email_status` (`email`,`account_status`),
...
INSERT INTO `users` VALUES (3,'Intan Keristina Mohd Yusop','intankeristina@gmail.com','$2y$10$AU9cYfAPpWnu8FP9DXVJZOFfVYDUmdC0AYMt0faI8Mucakg7wJ0pu','lecturer','pending','Kolej Vokasional Kuala Selangor','Penyelaras Inovasi Program Teknologi Maklumat',NULL,NULL,NULL,'2026-07-18 08:45:00','2026-07-18 08:45:00');
...
-- Dump completed on 2026-07-18 17:26:30
